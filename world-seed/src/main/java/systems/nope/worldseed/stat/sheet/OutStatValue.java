...
public class OutStatValue {
    ...
    public OutStatValue(int id, String name, String nameShort, int statSheet, String unit, int world, String type) {
        this.id = id;
        this.name = name;
    ...
    public static OutStatValue fromStatValueConstant(StatValueConstant statValueConstant) {
        return new OutStatValue(
